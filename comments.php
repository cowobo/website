...
<h3><?php if($count<1) echo 'Share your thoughts:'; else echo 'Messages ('.$count.')';?></h3><?php if($count>2):?><span class="showall button">Show All &darr;</span><?php endif;?>
...
if ($social->state > 1):?>
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" class="commentform">
		...
		<input type='checkbox' name='privatemsg' value='1' /> Private<br/>
		</div>
