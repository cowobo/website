...
* 	Syntax:
* 	<?php $posts = new Cowobo_Feed ( $args, $wp_query ); ?>
*
* 	Arguments:
* 	$args = array(
* 		'posts' => [ array or single post ],
* 		'cats'=> [ array, comma separated or single category ] ,
* 		'users' => [ array or single user id ] (fetches personal feed),
* 		'sort' => [ ASC or DESC ]
*	);
*	$wp_query = [ Normal WordPress query ]
*
...
class Cowobo_Feed {
	...
	function __construct($args, $wp_query = false) { 
