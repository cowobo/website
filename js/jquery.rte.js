    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                    ...
                    <a href='#' class='bold' alt='bold'></a>\
                    <a href='#' class='italic' alt='italic'></a>\
                    <a href='#' class='unorderedlist' alt='unordered list'></a>\
                    <a href='#' class='link' alt='link'></a>\
                    <a href='#' class='disable' alt='html mode'>html mode</a>\
					</div></div>");
